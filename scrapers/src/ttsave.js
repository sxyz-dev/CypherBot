...
class ttsavekrep {
ttslide = async function ttslide(url) {
  return ttsave.slide(url)
}

ttvideo = async function ttvideo(url) {
  return ttsave.video(url)
}

ttmp3 = async function ttmp3(url) {
  return ttsave.mp3(url)
}
}
